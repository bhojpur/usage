...
func (ListenRequestLogs) Descriptor() protoreflect.EnumDescriptor {
	return file_usage_proto_enumTypes[1].Descriptor()
}

func (ListenRequestLogs) Type() protoreflect.EnumType {
	return &file_usage_proto_enumTypes[1]
}
...
func (EngineTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_usage_proto_enumTypes[2].Descriptor()
}

func (EngineTrigger) Type() protoreflect.EnumType {
	return &file_usage_proto_enumTypes[2]
}
...
func (EnginePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_usage_proto_enumTypes[3].Descriptor()
}

func (EnginePhase) Type() protoreflect.EnumType {
	return &file_usage_proto_enumTypes[3]
}
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_usage_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_usage_proto_enumTypes[4]
}
...
var file_usage_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x75, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76,
	...
	0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa8, 0x04, 0x0a, 0x0c, 0x55, 0x73, 0x61, 0x67,
	...
	0x2f, 0x62, 0x68, 0x6f, 0x6a, 0x70, 0x75, 0x72, 0x2f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x70,
...
var file_usage_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_usage_proto_depIdxs = []int32{
	...
	5,  // 27: v1.UsageService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.UsageService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.UsageService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.UsageService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.UsageService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.UsageService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.UsageService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.UsageService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.UsageService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.UsageService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.UsageService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.UsageService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.UsageService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.UsageService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.UsageService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.UsageService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_usage_proto_init() {
	...
	file_usage_proto_msgTypes[14].OneofWrappers = []interface{}{
